...
(function ($) {
    ...
    $.flagStrap = function (element, options, i) {
        ...
        plugin.init = function () {
            ...
            var text = countries[lang];
            console.log(text);
            plugin.selected = {value: lang, text: text};
            ...
            // Check to see if the  callback method is assigned / callable, bind the change event for broadcast
            if (plugin.settings.onSelect !== undefined && plugin.settings.onSelect instanceof Function) {
                $(htmlSelect).change(function (event) {
                    var element = this;
                    var text = countries[$(element).val()];
                    options.onSelect($(element).val(), text,element);
                });
            }
